...
-(void) drawRect:(CGRect)rect {
  ...
  if (self.popFromSide) {
    ...
    [path addLineToPoint:CGPointMake(maxX - 40, minY)]; //Upper Right Pre Curve
    [path addQuadCurveToPoint:CGPointMake(maxX - 30, minY + 10) controlPoint:CGPointMake(maxX - 30, minY)];
    [path addLineToPoint:CGPointMake(maxX - 30, self.touchPoint.y - 20)];//Pre Point
    ...
    [path addQuadCurveToPoint:CGPointMake(maxX - 40, maxY) controlPoint:CGPointMake(maxX - 30, maxY)]; // Lower Right Post Curve
