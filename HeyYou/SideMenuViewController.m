...
-(NSString *)termsOfUse {
  ...
  returnString = [returnString stringByAppendingString:@"\n\nThat said, we take inappropriate content very seriously. Content that has been flagged as inappropriate will be reviewed an possibly removed. Users that post such content will be banned from the service."];
